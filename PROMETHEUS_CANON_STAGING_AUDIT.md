...
RC2 package hash reviewed as historical release-candidate evidence; not reproduced here as an active canonical checksum. Active staging hashes are maintained in PROMETHEUS_CANON_STAGING_CHECKSUMS.txt.
